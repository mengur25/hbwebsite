        ...
        <div class="row">
            ...
            while ($data = mysqli_fetch_assoc($result)) {
                ...
                if ($data['booking_status'] == 'booked') {
                    ...
                    if ($data['arrival'] == 1) {
                        $btn = "<a href='generate_pdf.php?gen_pdf&id=$data[booking_id]' class='btn btn-dark btn-sm shadow-none mt-2'> Download PDF </a>
                        ";
                        if ($data['rate_review'] == 0) {
                            $btn .= "<button type='button' onclick='review_room({$data['booking_id']}, {$data['room_id']})' data-bs-toggle='modal' data-bs-target='#reviewModal' class='btn btn-dark btn-sm shadow-none ms-2 mt-2'>Rate & Review</button>";
                        }
                    } else {
                ...
                <form id="review-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="text" name="review" class="form-control shadow-none"></textarea>
                        </div>
