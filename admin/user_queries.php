...
if (isset($_GET['seen'])) {
    ...
    if ($frm_data['seen'] == 'all') {
        $q = "UPDATE `user_queries` SET `seen`= 1";
...
if (isset($_GET['del'])) {
    ...
    if ($frm_data['del'] == 'all') {
        ...
        if (mysqli_query($con, $q)) {
            ...
            header("Location: user_queries.php"); // Chuyển hướng để tránh gọi lại ?del=all
            exit();
        } else {
            alert('error', 'Operation failed!');
        }
        ...
        if (delete($q, $values, 'i')) {
            ...
            header("Location: user_queries.php"); // Chuyển hướng để tránh lặp lại lệnh xóa
            exit();
        } else {
            alert('error', 'Operation failed!');
        }
