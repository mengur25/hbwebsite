                        ...
                        <form id="general_s_form">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label fw-bold">Site Title</label>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="form-check form-switch">
                                <form>
                                    ...
                                    <input onchange="upd_shutdown(this.value)" class="form-check-input" type="checkbox" id="shutdow_toggle">
                                </form>
                            </div>
                        </div>
                        <p class="card-text">
                                    ...
                                    <div class="container-fluid p-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label fw-bold">Google Map Link</label>
                                                    <input type="text" name="gmap" id="gmap_inp" class="form-control shadow-none" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label fw-bold">Phone Numbers (with cuntry code)</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="mail" name="email" id="email_inp" class="form-control shadow-none" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label fw-bold">Social Links</label>
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"><i class="bi bi-tiktok"></i></span>
                                                        <input type="text" name="tiktok" id="tiktok_inp" class="form-control shadow-none">
                                                    </div>
                                                    <div class="input-group mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label fw-bold">iframe Src</label>
                        ...
                        <form id="team_s_form">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label fw-bold">Picture</label>
