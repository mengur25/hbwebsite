                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Area</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Adult (Max.)</label>
                                <input type="number" min="1" name="adult" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Children (Max.)</label>
                                <input type="number" min="1" name="children" class="form-control shadow-none" required>
                            </div>
                            <div class=" col-12 mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Features</label>
                                <div class="row">
                                    <?php
                            ...
                            <div class=" col-12 mb-3">
                                <label for="exampleFormControlInput1" class="form-label fw-bold">Facilities</label>
                                <div class="row">
                                    <?php
                ...
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            <label for="exampleFormControlInput1" class="form-label fw-bold">Add Image</label>
