...
<body class="bg-light">
                    ...
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex-end align-items-center rounded mb-3" style="font-size: 18px">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        ...
                                        <input type="number" id="adults" min="1" value="<?php echo $adult_default?>" oninput="guests_filter()" class="form-control shadow-none">
                                    </div>
                                    <div>
                                        <label class="form-label">Children</label>
                                        <input type="number" id="children" min="1" value="<?php echo $children_default?>" oninput="guests_filter()" class="form-control shadow-none">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        let roooms_data = document.getElementById('rooms-data');
        ...
        function fetch_rooms() {
            ...
            if (get_facilities.length > 0) {
                get_facilities.forEach((item) => {
                    facility_list.facilities.push(item.value);
                });
            ...
            xhr.onprogress = function() {
                roooms_data.innerHTML = `<div class="spinner-border text-info mb-3 d-block mx-auto" id="loader" role="status">
                    <span class="visually-hidden">Loading...</span>
                </div>`;
            }
            xhr.onload = function() {
                roooms_data.innerHTML = this.responseText;
            }
