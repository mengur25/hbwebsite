        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                ...
                <div class="bg-white rounded shadow p-4">
                    ...
                    <a href="<?php echo $contact_r['facebook'] ?>" class="d-inline-block text-dark fs-5 me-2">
                        <i class="bi bi-facebook me-1"></i>
                    </a>
                    <a href="<?php echo $contact_r['instagram'] ?>" class="d-inline-block text-dark fs-5">
                ...
                <div class="bg-white rounded shadow p-4">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="email" required type="email" class="form-control shadow-none" placeholder="example@mail.com">
                        </div>
                        <div class="mb-3">
