                    ...
                    <form id="info-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input name="dob" type="date" value="<?php echo $u_fetch['dob'] ?>" class="form-control shadow-none" placeholder="Date of birth" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Pincode</label>
                                <input name="pincode" type="number" value="<?php echo $u_fetch['pincode'] ?>" class="form-control shadow-none" placeholder="Pincode" required>
                            </div>
                        ...
                        <button type="submit" name="register" class="btn custom-bg text-white shadow-none">Save Changes</button>
                    </form>
                </div>
            </div>
            ...
            <div class="col-4 my-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    <form id="profile-form">
                        ...
                        <img src="<?php echo USERS_IMG_PATH . $_SESSION['uPic'] . '?t=' . time(); ?>" alt="Profile Picture" class="profile-img">

                        <label class="form-label">New Picture</label>
                        <input name="profile" type="file" accept=".png, .jgp, .jpeg, .webp" class="mb-4 form-control shadow-none" placeholder="name@example.com" required>
