                    ...
                    echo <<<data
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg-end">
                                    <li><a class="dropdown-item text-white" style="background-color: #343a40;" href="profile.php">Profile</a></li>
                                    <li><a class="dropdown-item text-white" style="background-color: #343a40;" href="bookings.php">Bookings</a></li>
                                    <li><a class="dropdown-item text-white" style="background-color: #343a40;" href="logout.php">Logout</a></li>
                                </ul>
                            </div>
                        data;
                } else {
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="profile" type="file" accept=".png, .jgp, .jpeg, .webp" class="form-control shadow-none" placeholder="name@example.com" required>
                            </div>
