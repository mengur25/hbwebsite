...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dataHash = sprintf('%s|%s|%s|%s|%s|%s|%s|%s|%s',
        $datarq['vnp_RequestId'], $datarq['vnp_Version'], $datarq['vnp_Command'],
        $datarq['vnp_TmnCode'], $datarq['vnp_TxnRef'], $datarq['vnp_TransactionDate'],
        $datarq['vnp_CreateDate'], $datarq['vnp_IpAddr'], $datarq['vnp_OrderInfo']
    );
    ...
    echo "<pre>API Response: $txnData</pre>";
}
?>
<!-- Giữ nguyên HTML từ file gốc -->
